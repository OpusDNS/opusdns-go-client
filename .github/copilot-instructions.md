...
CI, the README, and the module toolchain are standardized on **Go 1.26.3** (`.github/workflows/ci.yml`, `README.md`, `go.mod`). Prefer matching CI when validating changes.
